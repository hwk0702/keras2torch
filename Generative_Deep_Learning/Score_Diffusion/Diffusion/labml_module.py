"""
This implementation contains a bunch of code from "https://github.com/labmlai/annotated_deep_learning_paper_implementations".
If you want to use full implementation of 'lambmlai', Please install package from 'labamlai'

Command : pip install labml-nn
